...
Note that all the odd order terms drop out of the Taylor series expansion (1.6) for D0u.xN /. This is typical with centered approximations and generally leads to a higher order approximation.
